...
function ManageFaculty() {
    ...
    return (
        <div className='h-screen overflow-y-scroll pb-10 bg-blue-50'>
            <div className="w-100 mt-16 max-md:mt-2 md:flex justify-center max-xl:px-2  ">
                ...
                :
                <table className='w-max text-center overflow-x-scroll' style={{ borderCollapse: 'collapse' }}>
                    <thead>
                        <tr className='bg-slate-950 text-white'>
                            <th className='border border-gray-400  py-2 px-2'>SR.No</th>
                            <th className='border border-gray-400 py-2 px-2'>Name</th>
                            <th className='border border-gray-400 py-2 px-2'>Email</th>
                            <th className='border border-gray-400 py-2 px-2'>Post</th>
                            <th className='border border-gray-400 py-2 px-2'>Qualification</th>
                            <th className='border border-gray-400 py-2 px-2'>Experience</th>
                            <th className='border border-gray-400 py-2 px-2'>Photo</th>
                    ...
                    <tbody className='bg-slate-800 text-white'>
                        {facultyList.map((faculty, index) => (
                            <tr key={faculty._id}>
                                ...
                                <td className='border border-gray-400 py-2 px-2'>{faculty.name}</td>
                                <td className='border border-gray-400 py-2 px-2'>{faculty.email}</td>
                                <td className='border border-gray-400 py-2 px-2'>{faculty.post}</td>
                                <td className='border border-gray-400 py-2 px-2'>{faculty.qualification}</td>
                                <td className='border border-gray-400 py-2 px-2'>{faculty.experience}</td>
